...
* (N6) A relação entre Lote e Histórico Preço precisa ser 1:N pois o Histórico Preço é um Conjunto de Entidade que guarda as atualizações de preço durante o período de existência do Lote no sistema. Isso significa que cada entidade do CE Histórico Preço representa uma atualização diferente do preço do Lote.
