...
- [x] **Trechos de Código SQL no Relatório:** Vocês precisam colar no PDF os blocos de código SQL das operações implementadas no sistema. Para cada bloco, é obrigatório ter 3 coisas:
...
- [x] **Conclusão / Análise Crítica (FATOR DE ZERAMENTO):** Adicionar uma página ou seção final de Conclusão contendo obrigatoriamente:
